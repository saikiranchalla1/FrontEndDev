...
!0})})["finally"](a.loading=!1):b.activate("cannotRemoveCard").then(function(){a.editingCreditCard=!0})["finally"](a.loading=!1)};a.formatCurrency=function(a){if("usd"==a)return"$";if("inr"==a)return"\u20b9"};d=function(){a.loading=!0;return e.get("me").then(function(b){a.loading=!1;b&&(_.each(b.subscriptions,function(a){var b=a.plan.amount;if(a.discount){var c=a.discount.coupon;c.percent_off&&(b-=b*c.percent_off/100);c.amount_off&&(b-=c.amount_off)}a.nextChargeAmount=b}),a.customer=b,a._addSimplifiedSubscriptionMetadata(a.customer.subscriptions),
a.customerCard=c.getDefaultCard(b),a.creditCard={})})};a.$on("refreshPageData",d);a._addSimplifiedSubscriptionMetadata=function(a){return _.each(a,function(a){a.setForCancellation=a.cancel_at_period_end;a.isLive="trialing"!==a.status||a.plan.metadata.trial_period_days&&0<a.plan.metadata.trial_period_days})};a.updateCreditCard=function(){var b=c.checkValidity(a.creditCard);a.creditCardErrors=b.errorText;b.valid&&(a.enabledCreditCardButton=!1,c.createPaymentToken("Update Credit Card",a.creditCard).then(function(a){return a.id}).then(function(a){return e.put("me",
{stripe_token:a})}).then(function(b){a.creditCardErrorMessage="";a.customer=b;a.customerCard=c.getDefaultCard(b);a.editingCreditCard=!1;a.enabledCreditCardButton=!0},function(b){a.creditCardErrorMessage=c.prettifyErrorResponse(b);a.enabledCreditCardButton=!0}))};d()}]);angular.module("account").factory("cancellationFlow",["modal","$q","api","$location","customers","CancellationFrame","products","recordActivity","dateTime","currentUser","$rootScope","$window",function(a,d,b,c,e,f,g,h,i,k,j,l){var m=k.fetchFullUser();return{cancelSubscription:function(c){var e=c.id,d=c.status,h=1E3*(c.trial_end||c.start),k=1E3*c.current_period_end,j=(Math.random().toString(36)+"000000000000000").slice(2,16),u=c.plan.id;"trialing"!==d&&i.calculateDaysBetweenDates(new Date(h),i.getCurrent());
f.setFlowToken(j);f.sendCancellationActivity("start");return m.then(function(){return g.get(u).then(function(a){try{return f.setCourseKey(a._course_groups[0].course_ref.key),b.get("/users/node_progress/"+f.getCourseKey()).then(function(a){f.setCompletionStats(a.data.stats);return a.data.stats})}catch(c){return f.setCourseKey("ndXXX")}})}).then(function(){return a.activate("postCancelSurvey",{subscriptionId:e,subscriptionPlanId:u,subscriptionPeriodEndDate:new Date(k)}).then(function(){l.location.reload()}).catch(function(){f.sendCancellationActivity("abort").then(function(){f.setCurrentFrame("cancelSurvey")})})},
...
setCurrentFrame:function(a){return d=a},getFlowToken:function(){return b},setFlowToken:function(a){return b=a},getCourseKey:function(){return c},setCourseKey:function(a){return c=a},getCourseType:g,sendCancellationActivity:function(e,d,k,j){var l=b,d=d||f(),m=c,n=g(),p,q;k&&(p=k);j&&(q=j);return a.cancellationFlowStep(l,d,m,n,e,p,q)},getCompletionStats:function(){return e},setCompletionStats:function(a){e={time:Math.round(a.time/60),projects:a.projects,quizzes:a.quizzes}},sufficientTimeInClass:function(){return 30<=
...
function(b){a.serverError=b.error;a.saveDisabled=!1}):a.saveDisabled=!1}}}]);angular.module("account").controller("developmentEnvironmentInfoTab",["$scope","currentUser","developmentEnvironments","$log",function(a,d){a.accountKey=d.get("key")}]);angular.module("account").controller("linkedAccountsTab",["$scope","$timeout","currentUser","users","google","facebook","normalizedSocialService","session","siteExperience",function(a,d,b,c,e,f,g,h,i){a.loading=!0;a.managed=i.managedAccount;a.accounts={google:null,facebook:null};var k=function(){a.serverSuccess="";a.serverError=""},j=function(b,c,e){c=g.normalizeAccount(b,c);c.id===a.user["_"+b+"_id"]||e?c.loggedIn=!0:c={loggedIn:!1};return a.accounts[b]=c},l=function(b){a.loading=!1;a.serverError=
b.error};a.getLinkedAccountTypes=function(){return _.keys(a.accounts)};a.disconnect=function(b){a.loading=!0;var e={key:a.user.key};e[b+"_id"]=null;c.put(e).then(function(c){k();a.loading=!1;a.user=c;"github"!==b&&(a.accounts[b]=null)},l)};a.disconnectSocial=function(b){a.loading=!0;var e={key:a.user.key},d=a.user.social_accounts.length&&"github"==b?"social_accounts":"external_accounts",f=null;_.each(a.user[d],function(a,c){if(a.account_type===b||a.affiliate_program_key===b)f=c});null==f?a.loading=
!1:(a.user[d].splice(f,1),e[d]=a.user[d],c.put(e).then(function(c){k();a.loading=!1;a.user=c;a[b]=null},l))};a.connect=function(b){a.loading=!0;var e=g.normalizeAccountService(b),f=function(g,h){var i=function(a){401===a.code&&f(g-1,3*h)};0===g&&(i=l);d(function(){e.getAccount().then(function(e){var d={key:a.user.key};d[b+"_id"]=e.id;c.put(d).then(function(c){e=j(b,e,!0);k();a.loading=!1;a.user=c},l)},i)},h)},i=function(){f(3,500)};e.login().then(function(a){a=g.createSessionData(b,a);h.put(a).then(i,
i)},l)};k();b.fetchFullUser().then(function(){a.loading=!1;a.user=b.getUser();_.each(a.user.social_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.user.external_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.getLinkedAccountTypes(),function(a){g.normalizeAccountService(a).getAccount().then(function(b){j(a,b)})})},l)}]);angular.module("account").controller("myCertificatesTab",["$q","$scope","$sce","currentUser","users","nodes",function(a,d,b,c,e,f){d.loading=!0;d.verifiedCertificates=[];d.nodeMap={};d.serverError="";var g=c.getUser();d.getBadges=function(){return _.filter(g._badges,function(a){return"Course Mastery"===a.name&&0<a.highest_level})};a.all([e.getCertificates("me").then(function(a){d.verifiedCertificates=a;a=_.map(a,function(a){return a.node_ref.key});return f.batchGet(a,{projection:"catalog"}).then(function(a){_.extend(d.nodeMap,
...
6):d}}]).filter("stringDate",["$filter",function(){var a=function(a){if(!a)return a;var b=a.lastIndexOf(".");if(-1===b)return a;var c=b+7;if(c>a.length)return a;for(var e=b+1;e<c;++e)if("0">a[e]||"9"<a[e])return a;return a.substring(0,b)+a.substring(c,a.length)};return function(d){return Date.parse(a(d))}}]);angular.module("filters").filter("formatCurrency",[function(){return function(a,d){if("object"==typeof Intl&&Intl&&"function"==typeof Intl.NumberFormat){if("USD"===d)return(a/100).toLocaleString("en-US",{style:"currency",currency:d});if("INR"===d)return(a/100).toLocaleString("en-IN",{style:"currency",currency:d})}else{var b=0>a?"-":"",a=Math.abs(a);if("USD"===d){var c=a%100;return b+"$"+Math.floor(a/100)+(c?"."+c:"")}if("INR"===d)return b+"\u20b9"+Math.floor(a/100)}return a+d}}]);angular.module("filters").filter("imageCropSize",[function(){return function(a,d){if(a)return a.match(/\/\/[^.\/]+\.(ggpht|googleusercontent)\.com\//)||a.match(/\/_ah\/img\//)?a=a.replace(/\=s\d+(-c)?/,"=s"+d+"-c"):a.match(/\/\/robohash\.org\//)&&(a=a+"?size="+d+"x"+d),a}}]).filter("imageSize",[function(){return function(a,d,b){if(a){b=0===b?void 0:b;d=0===d?void 0:d;if("number"!==typeof d&&"number"!==typeof b)return a;var c=Math.max(b,d)||b||d;if(a.match(/\/\/[^.\/]+\.(ggpht|googleusercontent)\.com\//)||
a.match(/\/_ah\/img\//)){var e=/#[\w=_\-&]*w=(\d+)&h=(\d+)/.exec(a);e&&(c=1*e[1],e=1*e[2],d=Math.min(b/e,d/c)||b/e||d/c,d=[c*d,e*d],a=a.replace(/\=s\d+(-c)?/,"=s"+Math.round(Math.max(d[0],d[1]))))}else a.match(/\/\/robohash\.org\//)&&c&&(a=a+"?size="+c+"x"+c);return a}}}]);angular.module("filters").filter("slugify",[function(){return function(a){if(_.isUndefined(a)||_.isNull(a))return a;a=a.replace(/^\s+/,"").replace(/\s+$/,"");a=a.replace(/[^\w\s-]/g,"");a=a.toLowerCase();return a=a.replace(/[-_\s]+/g,"-")}}]);angular.module("filters").filter("titleCase",function(){return function(a){return(void 0===a||null===a?"":a).toString().toLowerCase().replace(/\b([a-z])/g,function(a){return a.toUpperCase()})}});angular.module("foundation").service("Amplitude",["$window","currentUser","applicationEnvironment",function(a,d,b){var c,e={setUserId:function(e,d){if(e.key&&a.amplitude){var h={};h.registered=e._registered;(c=_.isUndefined(d)?!b.isInDevelopment():d)?(a.amplitude.setUserProperties(h),a.amplitude.setUserId(e.key)):(console.groupCollapsed("Amplitude.setUserId Test Environment Details"),console.log("amplitude.setUserProperties() would be passed: "),console.log(h),console.log("amplitude.setUserId() would be passed: \n"+
e.key),console.groupEnd())}},logEvent:function(e,d,h){a.amplitude&&((c=_.isUndefined(h)?!b.isInDevelopment():h)?d?a.amplitude.logEvent(e,d):a.amplitude.logEvent(e):(console.groupCollapsed("Amplitude.logEvent Test Environment Details"),console.log("amplitude.logEvent() would be passed: \n"+e),d?console.log(d):"",console.groupEnd()))}};e.setUserId(d.getUser());return e}]).directive("ampLogEvent",["Amplitude",function(a){return function(d,b,c){var e,f,g;c.$observe("ampLogEvent",function(a){e=a});c.$observe("ampEventProperty",
function(a){f=a});c.$observe("ampEventPropertyObject",function(a){g=a});b.bind("click",function(){if(!c.ampLogEventIf||d.$eval(c.ampLogEventIf))c.ampEventProperty?a.logEvent(e,{key:f}):c.ampEventPropertyObject?a.logEvent(e,g):a.logEvent(e)})}}]);angular.module("foundation").service("localStorage",["$window",function(a){return{getItem:function(d){return a.localStorage?a.localStorage.getItem(d):null},setItem:function(d,b){return a.localStorage?a.localStorage.setItem(d,b):null}}}]);angular.module("foundation").factory("myCourses",["$rootScope","$timeout","currentUser","nodes","nodeUtility",function(a,d,b,c,e){var f,g={getNodeMap:function(a){f=!a&&f||c.batchGet(_.pluck(g.getDisplayedEnrollments(),"node_key"),{projection:"navigation"});return f.then(function(a){return a})},getDisplayedEnrollments:function(){return b.getEnrollmentsWithState("enrolled").concat(b.getEnrollmentsWithState("interested"))},getSortedEnrollments:function(a){return g.getNodeMap().then(function(b){var c=
...
"localStorage",function(f,g,h,i,k,j){var l=["sessionExpired"];f.defaults.headers.common["X-Udacity-Client"]="udacity.com; version="+i;var m=function(c){var i={get:function(b,e,g){g=g||{};"yes"===j.getItem("bustAllTheCaches")&&(e=e||{},e.cacheBusterValue=Math.random());g.params=a(e);g.cache=!0;var h=i.buildGetUrl(b,e),k=d();return 1600<h.length?(g.lengthy||console.warn("Url potentially too large for GET request; switching to POST. Set configuration option lengthy=true to suppress this warning."),delete g.params,
b+=(-1===b.indexOf("?")?"?":"&")+"_method=GET",i.verifySession(i.timeRequest(f.post(c.baseUrl+b,e,g),k))):i.verifySession(i.timeRequest(f.get(c.baseUrl+b,g),k))},post:function(a,b,e){var g=d();return i.verifySession(i.timeRequest(f.post(c.baseUrl+a,b,e),g))},deleteRequest:function(a,b,e){e=e||{};e.params=b;b=d();return i.verifySession(i.timeRequest(f["delete"](c.baseUrl+a,e),b))},timeRequest:function(a,b){return a.success(function(a,c,e){a=e("X-Udacity-Trail");c=d()-b;e=h.location.pathname+h.location.hash;
0<=c&&36E5>c&&k.trackTiming({"var":a||"unknown",category:"request",label:e,value:c})})},getCurrentUserKey:function(){return e=e||f({method:"GET",cache:!0,url:"/api/session"}).then(function(a){return a.data.account.key})},verifySession:function(a){return a.success(function(a,b,c){i.getCurrentUserKey().then(function(a){var b=c("X-Udacity-Account-Id");b&&b!==a&&i.emitEvent("sessionExpired",{accountId:a})})}).error(function(a,b,c){i.getCurrentUserKey().then(function(a){var e=c("X-Udacity-Account-Id");
...
encodeURIComponent(b)+"/enrollments",f).then(function(a){return a.data.modified_enrollments},function(){return a.reject("Failed to change enrollments")})},sendFinalStepsEmail:function(a,c,e){return d.post("/users/"+a+"/enrollments/"+c+"/send_final_steps_email",{is_bd:e})},changeEnrollmentSettings:function(a,c,e){return d.post("/users/"+encodeURIComponent(c)+"/enrollments/"+encodeURIComponent(a)+"/settings",e)},getCertificates:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/certificates",
c).then(function(a){return a.data.certificates})},setFinalStepsEmailSent:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"final_steps_email_sent",tag:c}]})},checkNewHomeBanner:function(a){return d.get("/users/"+a+"/tags",{namespace:"showNotificationBanner",tag:"hidden"})},setNewHomeBanner:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"showNotificationBanner",tag:"hidden"}]})},setAddToCalFlag:function(a,c){return d.post("/users/"+
a+"/tags",{tags_to_add:[{model:"Tag",namespace:"showAddToCalBanner",tag:c}]})},setHideAug15TOS:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"tos",tag:"hideAug15TOS"}]})},setOnboardingFlag:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"ndonboarding",tag:c}]})},getTags:function(){return d.get("/users/me/tags")},getStudyGroups:function(a){return d.get("/study_groups/get_for_user/"+a).then(function(a){return a.data.groups})},
fetchJWTForLayer:function(a){return d.post("/session/chat/jwt",{nonce:a}).then(function(a){return a.data.identity_token})},addToEmailList:function(a,c,e,f){a={email_address:c,user_name:a,list_name:e};f&&(a.data=f);return d.post("/users/join_email_list",a)},getSignatureUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+"/signature/upload_url").then(function(a){return a.data.url})},getImageUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+"/image/upload_url").then(function(a){return a.data.url})},
getTutors:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/tutors",c).then(function(a){return a.data})},getTutees:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/tutees",c).then(function(a){return a.data})},setTutor:function(a,c,e){return d.post("/users/"+encodeURIComponent(a)+"/enrollments/"+encodeURIComponent(c)+"/tutor",{tutor_account_key:e}).then(function(a){return a.data})},removeTutor:function(a,c,e){return d.deleteRequest("/users/"+encodeURIComponent(a)+"/enrollments/"+
encodeURIComponent(c)+"/tutor",{tutor_account_key:e}).then(function(a){return a.data})}}}]);angular.module("embedded").constant("tags",{collection:"k-",course:"c-",lesson:"l-",exercise:"e-",morsel:"m-",tidbit:"t-"}).constant("typeForTag",{"k-":"collection","c-":"course","l-":"lesson","e-":"exercise","m-":"morsel","t-":"tidbit"});angular.module("utility").directive("qualarooSurveyInfoHack",["qualarooSurveyor","dateTime","currentUser","cookieJar","qualaroo",function(a,d,b,c,e){return{link:function(){if(b.userIsLoggedIn()){var c=d.getCurrent(),g=new Date(c.setDate(c.getDate()-21));a.fetchEarliestPaidEnrollmentDate(b.getUser()).then(function(c){e.set({paid:c?"yes":"no"});e.set({subscribed_over_three_weeks:c&&c<g?"yes":"no"});e.set({gt:a.everEnrolledInGtCourses(b.getUser())?"yes":"no"})})}}}}]);angular.module("utility").factory("qualarooSurveyor",["dateTime","$q","nodeUtility","nodes",function(a,d,b,c){var e={fetchEarliestPaidEnrollmentDate:function(a){var g=_.without(_.filter(a._enrollments,function(a){return a.first_paid_enrollment_time},null,void 0));return g.length?c.batchGet(_.pluck(g,"node_key")).then(function(a){var c=_.filter(g,function(c){return _.any(a,function(a){return b.isCurrentEnrolled(c,a)})}),c=_.map(c,function(a){return e._convertIsoDateToYearMonthDayDate(a.first_paid_enrollment_time)});
...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","cookieJar","googleTagManager","universalAnalytics",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(){return{start:"September 15 at 12:00 pm Eastern Time",end:"September 24 at 11:59 pm Eastern Time"}},
c=function(){h.pushTrackingEvent("nanodegreeAccess");f.location.href="/me"};a.getNanodegreeButtonInfo=function(){return a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"nanodegree is live, student is enrolled or graduated",text:"Continue Nanodegree",action:c}:a.isPaidEnrollable?a.isClassFull?a.isPaidWaitlisted?(g.exists("udacity_notify_me_clicked_recently")&&(h.pushTrackingEvent("notificationListJoin"),i.trackEvent({category:"Waitlist",action:"SignUp",label:a.courseKey}),g.remove("udacity_notify_me_clicked_recently")),
{variant:"nanodegree is full, student is waitlisted",statusMessage:"You will be emailed when enrollment opens "+b().start,statusSuccess:!0}):{variant:"nanodegree is full, student not waitlisted, not enrolled",text:"Notify me",sidenote:"when nanodegree re-opens",statusMessage:"<strong>Next enrollment opens "+b().start+".</strong><br>You can start the program immediately after you enroll.",action:function(){g.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});
a._joinGroup(a.waitlistGroupKey)}}:{variant:"nanodegree live, student not enrolled",text:"Enroll in Nanodegree",sidenote:"After 1 week free trial",statusMessage:"<strong>Enrollment closes "+b().end+".</strong><br>You can start the program immediately after you enroll. ",action:function(){h.pushTrackingEvent("nanodegreeEnrollment");"nd801"==a.courseKey?f.location.href="/nanodegree/android-expectation-quiz":a._purchaseCourse()}}:{variant:"nanodegree not open for paid enrollment",sidenote:"This nanodegree is not yet available for enrollment"}};
...
(a.fieldErrors=e.errorText,a.buttonDisabled=!1)};a.signInFacebook=function(){return k.getAuthResponse().then(function(a){return c.put({facebook:{signed_request:a.signedRequest}}).then(n,q)},p)};a.signInGoogle=function(){i.getToken(!1).then(function(a){return c.put({google:{token:a.code}}).then(n,q)},p)};a.hasLongCookieString=function(){return 3E3<document.cookie.length}}]);angular.module("account").controller("signUpForm",["$scope","$q","$sce","$timeout","session","users","currentUser","groups","validator","google","facebook","$location","safelyRedirect","googleTagManager","retry","cookieJar","universalAnalytics",function(a,d,b,c,e,f,g,h,i,k,j,l,m,n,p,q,r){a._removeEmailCookie=function(){q.exists("emailAddressForSignUp")&&q.remove("emailAddressForSignUp",{path:"/"})};var s=function(){var b=function(){var b=a.initialSearch.next;b?m(b):m("/")},c=a.initialSearch.enroll,
e=a.initialSearch.enroll_state||"enrolled",f=a.initialSearch["join-group"],e=c?g.enroll(c,e,!0):d.when(!0),i=f?g.fetchFullUser().then(function(){return h.addMember(f,g.get("key"))}):d.when(!0),k,j;a._removeEmailCookie();k=c?r.trackEvent({category:"SignUp",action:"Enroll",label:c}):r.trackEvent({category:"SignUp",action:"Direct"});j=n.pushTrackingEvent("RegistrationCompleted");return e["finally"](function(){return i["finally"](function(){return k["finally"](function(){return j["finally"](b)})})})},
...
first_name:a.firstName,last_name:a.lastName,password:a.password,tos_accepted:!0}).then(s,t):(a.fieldErrors=b.errorText,a.buttonDisabled=!1)};a.signUpFacebook=function(){return j.getAuthResponse().then(function(a){return j.getMeResponse().then(function(b){return f.registerUser({email_address:b.email,first_name:b.first_name,last_name:b.last_name,facebook:{signed_request:a.signedRequest},tos_accepted:!0}).then(s,t)},u)},w)};a.signUpGoogle=function(){k.getToken(!1).then(function(a){return e.put({google:{token:a.code}}).then(s,
function(){return p(k.getMeResponse,5,100).then(function(a){return k.getToken(!0).then(function(b){return f.registerUser({email_address:a.email,first_name:a.given_name,last_name:a.family_name,google:{token:b.code},tos_accepted:!0}).then(s,t)},w)},u)})},w)};q.exists("emailAddressForSignUp")&&(a.email=q.get("emailAddressForSignUp"))}]);angular.module("account").controller("viewerSettings",["$scope","currentUser","users","techDetect","$window",function(a,d,b,c){a.isBrowserIE="Explorer"===c.browserStats().browser;a.videoQualities=[{label:"Automatic",value:"default"},{label:"360p",value:"medium"},{label:"480p",value:"large"},{label:"720p",value:"hd720"},{label:"1080p",value:"hd1080"}];a.playbackRates=[{label:"0.25x",value:0.25},{label:"0.5x",value:0.5},{label:"Normal",value:1},{label:"1.5x",value:1.5},{label:"2x",value:2}];var e=d.getUser();
...
a.save=function(){a.serverSuccess=a.serverError="";a.saving=!0;e.site_preferences={use_html5_player:a.settings.useHtml5Player,auto_advance:a.settings.autoAdvance,playback_rate:a.settings.playbackRate.value,video_quality:a.settings.videoQuality.value};b.put(e).then(function(){a.saving=!1;a.serverSuccess="Classroom Settings Saved"},function(b){a.saving=!1;a.serverError=b.error})}}]);angular.module("payment").controller("checkoutPage",["$scope","paymentFlow","$routeParams","$location","api","currentUser","cacheVersion","modal","dateTime","$timeout","universalAnalytics",function(a,d,b,c,e,f,g,h,i,k,j){f.get("_registered")||(window.location.href="/account/auth#!/signup?next="+encodeURIComponent(window.location.href));a.$on("$routeChangeSuccess",function(){j.trackVirtualPageView();if(angular.isDefined(b.stepNumber)&&d.isInFlow())d.goToStep(b.stepNumber);else{var e=[];c.search().products?
(e=c.search().products.split(","),d.begin(e),a.flow=d.getCurrentFlowData()):window.history.back()}});a.getCurrentDate=function(){return i.getCurrent()};a.isProductLaunched=function(a){return a&&a.launch_date&&new Date(a.launch_date)<i.getCurrent()};a.isProductNotLaunched=function(a){return a&&!a.was_launched};a.getGoToNanodegreeLink=function(b){return b&&b.shouldSeeOnboarding?"/teams/#/onboarding/"+a.flow.uriEncodedCourseKey:"/me"};a.getDescStringByCourseType=function(a){switch(a){case "Degree":return"Nanodegree";
...
a.getCurrentStep=d.getCurrentStep;a.getCurrentFlowSteps=d.getCurrentFlowSteps;k(function(){a.getCurrentUserIsVerified()||h.activate("verify email")},1)}]);angular.module("page.payment",["core"]).config(["$routeProvider",function(a){a.when("/:stepNumber",{}).otherwise({redirectTo:"/0"})}]);angular.module("payment").constant("DAY_IN_MILLISECONDS",864E5).factory("fullClassExperienceFlowDefinition",["$q","stripeCreditCard","validator","api","currentUser","products","customers","couponCode","users","$timeout","$log","nodes","DAY_IN_MILLISECONDS","userTrials","googleTagManager","universalAnalytics",function(a,d,b,c,e,f,g,h,i,k,j,l,m,n,p,q){var r=function(a){return"card_declined"===a.code?"Your card was declined. Please try again. If this issue persists, please contact payment-support@udacity.com.":
"processing_error"===a.code?"An error occurred while processing your card. Please try again.If this issue persists, please contact payment-support@udacity.com.":a.code?a.message:"An error occurred while processing your card. Please check your information and try again. If this issue persists, please contact payment-support@udacity.com."},s=function(a){return a&&_.map(a._course_groups,function(a){return a.course_ref&&a.course_ref.key})},w=function(b,d){var e={product_keys:d.productKeys};b&&b.id&&(e.stripe_token=
...
return a.reject(b)});e.then(function(){return d.course.isNanodegree&&d.course.shouldSeeOnboarding?i.setOnboardingFlag("me",d.course.key):a.when()});return e};return[{label:"Checkout",view:"/templates/angular/payment/payment_form.html",onStart:function(b,e){var i=[f.get(e.productKeys[0]),g.get("me")];if(h){var k=c.get("/coupons/"+h+"/compute_discount",{product_key:e.productKeys[0]}),k=k.then(function(a){e.coupon=a.data.coupon;a.data.coupon.valid&&(e.coupon.discounted_price=a.data.result)},function(){e.coupon=
{valid:!1};return null});i.push(k)}a.all(i).then(function(a){e.product=a[0];var b=_.first(e.product._course_groups).course_ref.key;l.get(b).then(function(a){var b=a.catalog_entry._image?a.catalog_entry._image.serving_url:null,c=a.overview_details?a.overview_details.should_see_onboarding:!1;e.confirmationStepLabel={Career:"Start program",Degree:"Start Nanodegree",Course:"Start course"}[a.getCourseType()];e.course={key:a.key,imageUrl:b,isNanodegree:a.isNanodegree(),isCareer:a.isCareer(),courseType:a.getCourseType(),
shouldSeeOnboarding:c};p.pushTrackingEvent("checkoutStart",{productName:e.product.name,productCurrency:e.product.currency,productPrice:e.product.amount,orderNodeKey:e.course.key,isNanodegree:a.isNanodegree,isCareer:a.isCareer,getCourseType:a.getCourseType})});b=e.product.trial_period_days;e.inTrialPeriod=0<b;e.trialPeriodStarts=new Date(Date.now()+b*m);e.customer=a[1];e.customerCard=d.getDefaultCard(e.customer);e.cardIsLoaded=!0;e.uriEncodedCourseKey=window.encodeURIComponent(s(e.product))})},onJump:function(a){return a.paymentConfirmed?
!1:!a.paymentConfirmed},onSubmit:function(b,c){if(c.customerCard)return w(!1,c);var e=b.creditCard||{},f=d.checkValidity(e);c.creditCardErrors=f.errorText;if(!f.valid)return!1;f=(c.product&&c.product.name)+", "+s(c.product);return d.createPaymentToken(f,e).then(function(a){return w(a,c)},function(b){c.generalPaymentFormError=r(b.error);return a.reject(b)})}},{getLabel:function(a){return a.confirmationStepLabel},view:"/templates/angular/payment/payment_confirmation.html",onStart:function(a,b){b.paymentConfirmed=
!0;b.payment=a;var c=b.product&&(b.product.amount||0)/100,d=null;try{d=_.find(a.customer.subscriptions,function(a){return a.plan.id===b.product.key}).id}catch(e){j.error("Failed to get Transaction Id",e)}q.trackTransaction({transactionId:d,transactionTotal:c,transactionAffiliation:"Udacity",transactionProducts:[{name:b.product&&b.product.name||"Missing product name, FILL IN IN CONTENT EDITOR ASAP FOR "+_.first(s(b.product)),sku:"DD44",price:c,quantity:1,category:_.first(s(b.product))}]});p.pushTrackingEvent("CompletedOrder",
...
getEmail:function(){return h.getEmail(j)},setUser:function(a){angular.copy(angular.copy(a),j)},fetchFullUser:function(a){var b=a?{cacheBust:Math.random()}:{};if(a)return c.get("me",b).then(function(a){n.setUser(a);return a});l||(l=c.get("me",b).then(function(a){n.setUser(a);return a}));return l},fetchCertificates:function(){return j._certificates?d.when(j._certificates):c.getCertificates("me").then(function(a){return j._certificates=a})},checkNewHomeBanner:function(){return c.checkNewHomeBanner("me")},
setNewHomeBanner:function(){return c.setNewHomeBanner("me")},setHideAug15TOS:function(){return c.setHideAug15TOS("me")},setFinalStepsEmailSent:function(a){return c.setFinalStepsEmailSent("me",a)},sendFinalStepsEmail:function(a,b){return c.sendFinalStepsEmail("me",a,b)},setAddToCalFlag:function(a){return c.setAddToCalFlag("me",a)},fetchCohorts:function(){m||(m=n.fetchFullUser().then(function(a){return d.all(_.map(a._cohort_keys,function(a){return i.get(a)}))},function(b){a.error(b)}));return m},userIsLoggedIn:function(){return j._registered},
isEnrolledIn:function(a){return _.some(j._enrollments,function(b){return b.node_key===a&&"enrolled"===b.state})},isEnrolledForCreditIn:function(a){var b=["151101088","150207572","151148782","151059885","151254701"];return void 0!==_.find(j._enrollments,function(c){var d=_.pluck(c.group_refs,"key");return c.node_key===a&&"enrolled"===c.state&&0<_.intersection(d,b).length})},isCourseEmailSubscribed:function(a){return 0<_.filter(j._enrollments,function(b){return b.node_key===a&&b.email_ok}).length},
enroll:function(a,d,e){d=d||"enrolled";return c.setEnrollments("me",[a],d).then(function(a){j._enrollments=j._enrollments||[];_.each(a,function(a){var b=_.find(j._enrollments,function(b){return b.node_key===a.node_key});b?j._enrollments[_.indexOf(j._enrollments,b)]=a:j._enrollments.push(a)});if(1===a.length){b.$broadcast("modifiedEnrollment",a);var c=d.slice(0,1).toUpperCase()+d.slice(1,-2),c=k.trackEvent({category:"Enrollment",action:c,label:a[0].node_key});return e?c.then(function(){return a},function(){console.warn("Failed to push enrollment to Universal Analytics");
return a}):a}return a})},changeEnrollmentSettings:function(a,b){return c.changeEnrollmentSettings(a,"me",b)},getEnrollmentsWithState:function(a){return _.filter(j._enrollments,function(b){return b.state===a})},getTags:function(){return c.getTags("/users/me/tags")},setTag:function(a,b){var e=n.get("tags");if(_.findWhere(e,{namespace:a,tag:b}))return d.when(e);var f=e.concat([{namespace:a,tag:b}]);j.tags=f;return c.put({key:n.get("key"),tags:f}).catch(function(a){j.tags=e;return d.reject(a)})},removeTag:function(a,
b){var e=n.get("tags");if(!_.findWhere(e,{namespace:a,tag:b}))return d.when(e);var f=_.reject(e,function(c){return c.namespace===a&&c.tag===b});j.tags=f;return c.put({key:n.get("key"),tags:f}).catch(function(a){j.tags=e;return d.reject(a)})},isNanodegreeStudent:function(){return Boolean(_.find(j._enrollments,function(a){return"nd"===a.node_key.slice(0,2)}))}};return n}]);angular.module("user").directive("userMenu",["currentUser","session",function(a,d){return{restrict:"A",link:function(b){b.isLoggedIn=a.userIsLoggedIn;b.user=a.getUser;b.isNanodegreeStudent=a.isNanodegreeStudent();var c=[/\/account/,/\/me/,/\/checkout/];b.logOut=function(){d.terminate().then(function(){var a=window.location.pathname;_.some(c,function(b){return b.test(a)})?window.location="/":window.location.reload()})}}}}]);angular.module("user").factory("userUtility",[function(){return{getFullName:function(a){if(a)return a.first_name&&a.last_name?a.first_name+" "+a.last_name:a.first_name||a.last_name},getEmail:function(a){return a.email&&a.email.address}}}]);angular.module("utility").directive("animatedToggle",function(){return{restrict:"A",link:function(a,d,b){b.toggleTarget||console.error("You must provide a toggle-target with a selector for the child element to toggle");b.toggler||console.error("You must provide an element to trigger the toggle");var c=d.find(b.toggleTarget),a=d.find(b.toggler);c||console.error("Element to toggle ("+b.toggleTarget+") not found!");a||console.error("Element to trigger toggle ("+b.toggler+") not found!");$(a).on("click",
...
"Z"},calculateDaysBetweenDates:function(a,b){return Math.abs((b.getTime()-a.getTime())/864E5)},_getActualMillisecondsSinceEpoch:function(){return(new Date).getTime()-d},convertDateToRightTimeZone:function(a){return new Date(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds())}};return b}]);angular.module("utility").factory("fetchDiscourseLink",["$q","currentUser","nodes","discourse",function(a,d,b,c){var e={},f={},g=function(g,i){var k=f[g];if("COURSE"===k&&e[g])return e[g].promise;if("LESSON"===k&&e[i])return e[i].promise;if(g&&0===g.indexOf("nd")){if(i){f[g]="LESSON";e[i]=a.defer();var j=null;b.get(i).then(function(a){var b=a.overview_details;if(b&&b.forum_slug)j="http://discussions.udacity.com/c/"+b.forum_slug;else if(("nd000"===g||"ca001"===g)&&a.forum_slug)j="http://discussions.udacity.com/c/"+
a.forum_slug;e[i].resolve(j?j:"http://discussions.udacity.com/categories")});return e[i].promise}f[g]="COURSE";e[g]=a.defer();e[g].resolve("http://discussions.udacity.com/categories");return e[g].promise}"LESSON"===k?e[i]=a.defer():e[g]=a.defer();d.fetchCohorts().then(function(d){var j=null,d=_.map(d,function(d){var k=a.defer();if(_.contains(d._course_keys,g))return b.batchGet([d.node_key],{depth:1}).then(function(a){a=_.where(a,{_semantic_type:"Project",_available:!0});a=_.filter(a,function(a){return _.find(a.overview_details.related_course_refs,
function(a){return a.key===g})});if(!j&&1===a.length){var b=_.first(a).overview_details.forum_slug;j="http://discussions.udacity.com/c/"+b;c.getCategories().then(function(a){var c=_.find(a,function(a){return a.slug===b}).id;if(a=_.find(a,function(a){return a.parent_category_id===c&&(-1!==a.slug.indexOf(g)||-1!==a.slug.indexOf(i))}))f[g]=-1!==a.slug.indexOf(i)?"LESSON":"COURSE",j=j+"/"+a.slug;k.resolve()})}else e[g].resolve("http://discussions.udacity.com/categories")}),k.promise});a.all(d).then(function(){"LESSON"===
k&&e[i]?e[i].resolve(j?j:"http://discussions.udacity.com/categories"):"LESSON"===k?(e[g].resolve(j?j:"http://discussions.udacity.com/categories"),e[i]=a.defer(),e[i].resolve(j?j:"http://discussions.udacity.com/categories")):e[g].resolve(j?j:"http://discussions.udacity.com/categories")})});return"LESSON"===k?e[i].promise:e[g].promise};g._FALLBACK_URL="http://discussions.udacity.com/categories";return g}]);angular.module("utility").directive("filePicker",[function(){return{require:"ngModel",scope:{buttonLabel:"=?"},template:'<span class="btn btn-default file-picker">{{buttonLabel || \'Choose File\'}}<input type="file" class="input-control-file"></span>',link:function(a,d,b,c){c.render=angular.noop;d.find("input").on("change",function(b){c.$setViewValue(_.first(b.target.files));a.$apply()})}}}]);angular.module("utility").service("fileQueue",["queue","api","$q",function(a,d,b){var c={uploadQueue:a("fileUpload"),blobStoreUploadTask:function(a,b,g){return c.fileUploadTask(d.get(a+"/upload_url").then(function(a){return a.data.url}),b,g)},fileUploadTask:function(d,f,g){return c.uploadQueue.newUniqueTask(function(a){var c=b.defer(),g=new XMLHttpRequest;g.onreadystatechange=function(){if(4===g.readyState)if(200===g.status){var a=JSON.parse(g.response.slice(5));c.resolve(a)}else c.reject(g.response&&
...
k};a.userIsLoggedIn=t.userIsLoggedIn();a.canEditNotes=D;a.course=null;a.lessons=null;a.lesson=null;a.morsels=null;a.morsel=null;a.tidbit=null;var v=b.path().match("/"+m.course+"([^/]+)"),i=b.path().match("/"+m.lesson+"([^/]+)"),v=v?v[1]:null,i=i?i[1]:null;a.courseKeyFromUrl=v;a.lessonKeyFromUrl=i;v||(window.location.href="/");s.addEventListener("sessionExpired",function(){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path())});w&&(window.location.href=
"/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path()));d.addEventListener("lessonPermissionDenied",function(){window.location.href="/course/"+v});d.addEventListener("courseChange",function(a){if((!a.lessons||0===a.lessons.length)&&!a.lastLessonVisited&&!c.lessonKey)window.location.href="/course/"+v}).addEventListener("coursePermissionDenied",function(){c.lessonKey||(window.location.href="/course/"+v)});d.addEventListener("lessonChange",function(a){if(!a.morsels||0===a.morsels.length)window.location.href=
"/course/"+v});a.isViewerLoading=!0;d.addEventListener("courseChange",function(){n.loadLibraries(["codemirror","mathquill"]).then(function(){},function(){F.error("Classroom failed to load a required library");alert("Failed to load some required parts of the course! Please refresh the page. If this issue persists, please contact support@udacity.com. Thanks!")})}).addEventListener("morselChange",function(){a.isViewerLoading=!1});d.addEventListener("courseChange",function(b){a.course=b.course;a.lessons=
b.lessons;a.enrollment=_.find(t.get("_enrollments"),function(a){return a.node_key===b.course.key});a.premiumAccess=x.hasPermissionTo(a.course,"view-paid-supplemental-media")||a.enrollment&&(x.isCurrentEnrolled(a.enrollment,b.course)||x.isGraduated(a.enrollment,b.course));E.set({isPaid:a.premiumAccess?"yes":"no"})},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("lessonChange",function(b){a.lesson=b.lesson;a.morsels=b.morsels},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("morselChange",
function(b){a.morsel=b;B(b)},{replayLast:!0}).addEventListener("tidbitChange",function(b){(a.tidbit=b.tidbit)&&B(b.tidbit)},{replayLast:!0});d.addEventListener("pendingLessonChange",function(){a.morsels=null;a.morsel=null;a.tidbit=null});a.$on("$routeChangeSuccess",function(b,f,g){if(b=!c.morselKey)if(!g||!f)b=!1;else{var h=g.pathParams,f=f.pathParams;if(_.keys(h).length===_.keys(f).length)b=!1;else{var i=!0;_.each(f,function(a,b){h[b]!==a&&(i=!1)});b=i}}b&&window.history.back();c.courseKey&&c.courseKey!==
v&&window.location.reload();g&&G.trackVirtualPageView();if((null===a.course||a.course.key!==c.courseKey)&&"none"!==c.courseKey)A(),d.addEventListener("courseChange",function(b){c.lessonKey||(b.lastLessonVisited?a.goToLesson(b.lastLessonVisited.key):a.goToLesson(b.lessons[0].key))},{removeAfterFired:!0}),d.changeCourse(c.courseKey);if((null===a.lesson||a.lesson.key!==c.lessonKey)&&c.lessonKey)A(),d.addEventListener("lessonChange",function(b){c.morselKey||(b.lastMorselVisited?a.goToMorsel(b.lastMorselVisited):
a.goToMorsel(b.morsels[0]))},{removeAfterFired:!0}),d.changeLesson(c.lessonKey);if((null===a.morsel||a.morsel.key!==c.morselKey)&&c.morselKey)e.logNodeVisit("morsel"),a.lesson&&a.lesson.key===c.lessonKey?d.changeMorsel(c.morselKey):d.addEventListener("lessonChange",function(){d.changeMorsel(c.morselKey)},{removeAfterFired:!0});if(null===a.tidbit||a.tidbit.key!==c.tidbitKey)c.tidbitKey&&e.logNodeVisit("tidbit"),a.morsel&&a.morsel.key===c.morselKey?d.changeTidbit(c.tidbitKey):d.addEventListener("morselChange",
function(){d.changeTidbit(c.tidbitKey)},{removeAfterFired:!0})});a.alert=function(a){alert(a)};a.log=function(a){console.log(a)};a.getCurrentMorselType=function(){return a.morsel?a.morsel.model:null};a.getStyleClassesForMorsel=function(b){var c="";if(a.morsel)if("Exercise"===b.model){if(b.completed||b.lecture_ref&&b.lecture_ref.completed)c+="is-viewed";if(b.key===(a.morsel.containingExercise?a.morsel.containingExercise.key:a.morsel.key))c+=" is-current"}else b.completed&&(c+="is-viewed"),a.morsel.key===
b.key&&(c+=" is-current");return c};a.getPlayerPartialForCurrentMorsel=function(){return z(a.morsel,"_player.html")};a.getPlayerExtensionPartialForCurrentMorsel=function(){return z(a.morsel,"_extension.html",!0)};a.getSidePanelPartialForCurrentMorsel=function(){return z(a.morsel,"_side_panel.html")};a.goToMorsel=function(e){(!e||!e.key)&&console.error("Cannot go to invalid morsel "+e);(!a.morsel||e.key!==a.morsel.key)&&f(function(){if("Exercise"===e.model){var a=e.lecture_ref||e.quiz_ref;d.announcePendingMorselChange(a);
...
c.morselKey):b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.morsel+c.morselKey):(!a.tidbit||d.key!==a.tidbit.key)&&f(function(){b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.exercise+d.containingExercise.key+"/"+m.morsel+d.containingExercise.quiz_ref.key+"/"+m.tidbit+d.key)})};a.goToNextMorsel=function(){var b=a.morsel,c=a.morsels.length;b.containingExercise&&(b=b.containingExercise);b=b.indexInLesson;b<c-1?a.goToMorsel(a.morsels[b+1]):(h.pauseVideo(),a.course?t.userIsLoggedIn()&&
t.isEnrolledIn(a.course.key)?a.lessons&&a.lesson.key===a.lessons[a.lessons.length-1].key?(a.enrollment=_.find(t.get("_enrollments"),function(b){return b.node_key===a.course.key}),u.activate("endOfCourse",{courseIsComplete:a.course.catalog_entry.complete,courseKey:a.course.key,isPaidEnrolled:x.isCurrentEnrolled(a.enrollment,a.course),isGraduated:x.isGraduated(a.enrollment,a.course)})):u.activate("endOfLesson",{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):t.userIsLoggedIn()?u.activate("endOfLessonEnrollGate",
{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):u.activate("endOfLessonSignInGate",{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):u.activate("endOfIsolatedContent"))};a.goToPreviousMorsel=function(){var b=a.morsel;b.containingExercise&&(b=b.containingExercise);b=b.indexInLesson;0<b?a.goToMorsel(a.morsels[b-1]):console.error("Can't go to previous; at beginning of lesson")};a.goToLesson=function(e){if(!a.lesson||e!==a.lesson.key)d.announcePendingLessonChange(),f(function(){b.path("/"+
m.course+c.courseKey+"/"+m.lesson+e)})};a.goToNextLesson=function(){if(a.lessons){var b=a.lessons.length,c=_.find(a.lessons,function(b){return b.key===a.lesson.key}).indexInCourse;0<=c&&c<b-1?a.goToLesson(a.lessons[c+1].key):console.error("Can't go to next; at end of course!")}else console.error("Can't go to next lesson, we're not in a course!")};a.os=r.os(!1);a.isActiveMorsel=function(b){return a.morsel&&a.morsel.key===b};a.getProgressPercentage=function(){return 77};a.isNanodegreeRelatedCourse=
function(a){return a?/\-nd/.test(a.key):!1};var y}]);angular.module("viewer").controller("viewerPlayer",["$scope","lesson","$timeout","$window","currentUser","userTrials",function(a,d,b,c,e,f){a.isPlayerLoading=!0;c=function(a){var b=["attempt-1","attempt-2","control"],a=_.reduce(("skip-button-test-"+a).split(""),function(a,b){return(37*a+b.charCodeAt(0))%1009},0);return b[a%b.length]};a.skipButtonTrial=e.userIsLoggedIn()?f.getOrEnrollManually("skip_button_trial",c,[e.get("key")]):"excluded";a.loadingComplete=function(c){c?b(function(){a.$apply(function(){a.isPlayerLoading=
...
b.$on("$destroy",function(){a.detach()})}}}]);angular.module("viewer").directive("contentGateWatcher",["lesson","currentUser","imageQuiz","programmingQuiz","$location","modal",function(a,d,b,c,e,f){return{restrict:"A",link:function(e){var h=d.userIsLoggedIn(),i=!1,k=function(){b.removeEventListener("correct",k);c.removeEventListener("evaluated",j);h?f.activate("enrollGate"):f.activate("signInGate")},j=function(a){a.result&&a.result.passed&&k()},l=function(){b.addEventListener("correct",k);c.addEventListener("evaluated",j)};a.addEventListener("courseChange",
...
!0,a=$.extend({},a),c.init(a))},{replayLast:!0,removeOnDestructionOf:b})},{removeOnDestructionOf:b,removeAfterFired:!0});d.addEventListener("tidbitChange",function(a){b.tidbitViewerMode=e.getTidbitViewerMode(a.tidbit)},{replayLast:!0,removeOnDestructionOf:b});var h=g.find(".code-mirror-holder"),i=g.find(".editor-file-tabs"),k=function(){h.outerHeight(g.height()-(b.files&&1<b.files.length?i.outerHeight():0))},j=_.debounce(k,750),l=_.throttle(k,200);$(window).on("resize",j);$(window).on("resize",l);
...
b.showFeedbackDialog=function(){b.morselTitle=b.morsel.title;"Video"===b.morsel.model?(g.pauseVideo(),b.feedbackOptions=k):b.feedbackOptions="ImageFormQuiz"===b.morsel.model||"ProgrammingQuiz"===b.morsel.model?j:l;c.activate("feedback")};var m=function(a){for(var a=_.pairs(a),b={},c=0;c<a.length;++c){var d=a[c][0],e=a[c][1];if(_.isObject(e))for(var e=_.pairs(m(e)),f=0;f<e.length;++f)b[d+"."+e[f][0]]=e[f][1];else void 0!==e&&null!==e&&(b[d]=e)}return b};b.submitFeedback=function(){b.formValidationResults=
a.check(b.form);if(b.formValidationResults.valid){var j=[{context:e.getCurrent(),data:{model:"SurveyResponse",survey_name:"LessonFeedbackVersion2"}}],k={reason:b.form.feedbackReason.value,explanation:b.form.feedbackExplanation.value,techDetect:f.getAllTech(),currentUrl:window.location.href};"Video"===b.morsel.model&&(k=_.extend(k,{youtube:{availablePlaybackRates:g.getAvailablePlaybackRates(),currentPlaybackRate:g.getCurrentPlaybackRate(),currentTime:g.getCurrentTime()}}));k=m(k);j[0].data.items=_.map(_.pairs(k),
...
(a.evaluation.model="SubmissionEvaluation");b(a).then(function(){},c)}var k=null,j=null,l=function(b,c){var c=c||{},d={items:_.map(b,function(a){return{occurrence_time:c.timestamp||e.getCurrentAsUTC(),content_context:_.without(a.context,null,void 0,"none"),data:a.data}}),current_time:e.getCurrentAsUTC()},f="/api/activity";c.chain&&(f+="?related_chain=true");return a.post(f,d).then(function(a){200!==a.status&&(console.error("Error when trying to post activity. Response:"),console.error(a))})};c.addEventListener("videoPlay",
function(a){k=a},{replayLast:!0});c.addEventListener("videoPause",function(a){null!==k&&(null!==a&&void 0!==a)&&(j=a,l([{context:b.getCurrent(),data:{model:"PlayableView",start:k,stop:j}}]));k=j=null},{replayLast:!0});f.addEventListener("evaluation",i,{replayLast:!0});g.addEventListener("evaluation",i,{replayLast:!0});d.addEventListener("morselChange",function(a){if(!a.completed&&("Reading"===a.model||"EmbeddedFrame"===a.model))d.markMorselAsCompleted(a.key),l([{context:b.getCurrent(),data:{model:"CompletedExperience",
...
{projection:"image"}).then(function(b){b&&b._image_url&&a.partners[d].push({imageUrl:b._image_url,name:b.name})})})};a.fetchCards=function(b,c){return d.batchGet(b,{fresh:!1}).then(function(d){return _.without(_.map(b,function(b){var e=!1,k=d[b];if(d[b]){var j=null,l=k.catalog_entry;l&&l._image&&(j=l._image.serving_url);c&&(k.affiliate_program_refs&&0<k.affiliate_program_refs.length)&&"udacity"!==k.affiliate_program_refs[0].key&&(e=!0,a._fetchAffiliate(k.affiliate_program_refs,b));return{key:b,_slug:k._slug,
servingUrl:j,title:k.title,isNanodegree:k.isNanodegree(),isCareer:k.isCareer(),getCourseType:k.getCourseType(),showPartner:e&&c}}return null}),null)})};a._setLengthOfRow=function(a,b){return!b||6<b?6>=a?a:0===a%6?6:0===a%5?5:0===a%4?4:0===a%3?3:6:b};a.setUpCards=function(b,d,g,h,i){b?(a.lengthOfRow=a._setLengthOfRow(b.length,d),a.columnWidthClass="col-xs-"+a._calculateColumnWidth(a.lengthOfRow),a.cardImageSize=[1200/a.lengthOfRow,0],angular.isArray(h)&&2===h.length?a.cardImageSize=h:angular.isNumber(h)&&
